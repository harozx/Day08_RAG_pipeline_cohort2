...
EMBEDDING_MODEL = "sentence-transformers/all-MiniLM-L6-v2"  # Vì sao? Nhẹ, chạy nhanh, phù hợp cho môi trường local
EMBEDDING_DIM = 384
...
def index_to_vectorstore(chunks: list[dict]):
    ...
    vectorstore_path = STANDARDIZED_DIR.parent / "vectorstore.pkl"
    with open(vectorstore_path, "wb") as f:
        pickle.dump(chunks, f)
    print(f"✓ Saved {len(chunks)} chunks with embeddings to {vectorstore_path}")
